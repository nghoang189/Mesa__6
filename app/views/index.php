              ...
              <div class="carousel-item">
                <div class="col-lg-6 col-md-8">
                  <div class="detail_box">
                    ...
                    <div>
                      <a href="?route=danh-sach">Buy Now</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-xl-7">
          <div class="img-box">
            <img src="../app/images/about-img.png" alt="" />
          </div>
        </div>
      ...
      <div class="img_container">
        <div class="box-1">
          <div class="box-1-container">
            <div class="b-1">
              <div class="img-box">
                <img src="../app/images/g-1.jpg" alt="">
              </div>
              <div class="img-box">
                <img src="../app/images/g-4.jpg" alt="">
              </div>
            </div>
            <div class="b-2">
              <div class="img-box">
                <img src="../app/images/g-2.jpg" alt="">
              </div>
              <div class="img-box">
                <img src="../app/images/g-5.jpg" alt="">
              </div>
            </div>
          </div>
          <div class="b-3">
            <div class="img-box">
              <img src="../app/images/g-7.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="box-2">
          <div class="img-box">
            <img src="../app/images/g-3.jpg" alt="">
          </div>
          <div class="img-box">
            <img src="../app/images/g-6.jpg" alt="">
          </div>
          <div class="img-box flex-grow-1">
            <img src="../app/images/g-8.jpg" alt="">
          </div>
        </div>
      </div>
  </section>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="client_box">
            <div class="detail_box">
              <div class="img_box">
                <img src="../app/images/client-1.png">
              </div>
              <h5>
                nomil du
              </h5>
        ...
        <div class="col-md-6">
          <div class="client_box">
            <div class="detail_box">
              <div class="img_box">
                <img src="../app/images/client-2.png">
              </div>
              <h5>
                zabih jo
              </h5>
      ...
      <div class="row">
              ...
              <div>
                <a href="">
                  <div class="insta-box b-1">
                    <img src="../app/images/insta-1.png" alt="">
                  </div>
                </a>
                <a href="">
                  <div class="insta-box b-2">
                    <img src="../app/images/insta-2.png" alt="">
                  </div>
                </a>
              </div>
              <div>
                <a href="">
                  <div class="insta-box b-3">
                    <img src="../app/images/insta-3.png" alt="">
                  </div>
                </a>
                <a href="">
                  <div class="insta-box b-4">
                    <img src="../app/images/insta-4.png" alt="">
                  </div>
                </a>
              </div>
              <div>
                <a href="">
                  <div class="insta-box b-3">
                    <img src="../app/images/insta-5.png" alt="">
                  </div>
                </a>
                <a href="">
                  <div class="insta-box b-4">
                    <img src="../app/images/insta-6.png" alt="">
                  </div>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-3">
          <div class="info_contact">
            ...
            <div>
              <img src="../app/images/location-white.png" alt="">
              <p>
                It is a long
                fact that a reader
              </p>
            ...
            <div>
              <img src="../app/images/telephone-white.png" alt="">
              <p>
                +01 1234567890
              </p>
            </div>
            <div>
              <img src="../app/images/envelope-white.png" alt="">
              <p>
                demo@gmail.com
              </p>
            </div>
