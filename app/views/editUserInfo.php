    ...
    <div class="limiter">
        ...
        <div class="container-login100" style="background-image: url('../app/images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="?route=update-user-info&idUser=<?= $data['Id'] ?>" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
                        ...
                        <input class="input100" type="password" name="Pass" value="" placeholder="Type your new Password">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
                        <span class="label-input100">Confirm Password</span>
                        <input class="input100" type="password" name="ConfirmPass" value="" placeholder="Type your new Password">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
