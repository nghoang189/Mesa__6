      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            <h3 class="form-title">ACCOUNT REGISTER</h3>
            <p class="text-danger">
              <?php
          ...
          <div class="card-body">
            <form action="?route=register" method="post">
              ...
              <div class="form-group">
                <label class="dark-grey-text" for="chuyennganh">User Name:</label>
              ...
              <div class="form-group">
                <label class="dark-grey-text" for="congty">Confirm Password:</label>
